...
1. O docente COMPLEMENTA o registro oriundo do _**Lattes**_.<br>O exemplo (figura abaixo) se refere ao tipo de registro "artigo completo publicado em periódico":
   - O docente precisa complementar:
        - projeto associado; e
        - classificação Qualis/CAPES.
   - Observe que o docente deve complementar o conteúdo da área editável na _interface_.<br><img src="../media/interface-lattes-2.jpg" width="500">
